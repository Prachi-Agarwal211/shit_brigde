          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 mb-32">
            <section className="space-y-8">
              <p className="text-2xl md:text-4xl text-white font-display leading-tight">
                We are building the logistics layer that Indian brands deserve.
              </p>
              <div className="w-12 h-1 bg-[#00ff87] rounded-full" />
              <p className="text-lg text-white/60 leading-relaxed font-light">
                ShipBridge started with one question: why is shipping in India still so hard? We set out to fix it with AI-powered software — smarter courier selection, automated returns, real tracking, and NDR management. A single dashboard that works across every Indian courier partner.
              </p>
              <p className="text-lg text-white/60 leading-relaxed font-light">
                We aren&apos;t just moving packages. Our platform helps D2C brands, SMEs, and marketplace sellers automate their entire shipping workflow — from order sync to final delivery — making logistics as simple as a few clicks.
              </p>
            </section>
            ...
            <section className="flex items-center">
              <div className="w-full aspect-[4/3] rounded-[2rem] bg-gradient-to-br from-[#064e3b]/20 to-[#0a0a0a] border border-white/10 flex items-center justify-center relative overflow-hidden group">
                ...
                <span className="text-[#00ff87]/60 text-sm tracking-widest font-bold z-10">
                  ...
                  <span className="block text-[8px] text-white/30 tracking-[0.5em] mt-2">SHIPPING ACROSS INDIA</span>
                </span>
              </div>
            </section>
          </div>
      ...
      <section className="relative py-24 md:py-32 px-5 md:px-12 overflow-hidden bg-transparent">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-12 md:gap-4 relative">
            ...
            {[
              { year: "2026", title: "Founded (Apr)", desc: "ShipBridge incorporated to fix Indian domestic shipping with AI-powered logistics software." },
              { year: "Q2 2026", title: "Beta Launch", desc: "Beta release of our AI-native shipping platform for Indian D2C brands and SMEs." },
              { year: "Q3 2026", title: "Pan-India Network", desc: "Integrated with major Indian courier partners for nationwide coverage." },
              { year: "Q4 2026", title: "Full Platform", desc: "Platform launched with COD, RTO, NDR, returns, and Shopify integration." },
      ...
      <section className="relative py-24 md:py-32 px-5 md:px-12 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { name: "Prachi Agarwal", title: "Chief Executive Officer", initials: "PA" },
              { name: "Anurag Singh", title: "Chief Technology Officer", initials: "AS" },
              { name: "Ashish Joshi", title: "Founder & CFO", initials: "AJ" },
            ].map((leader, idx) => (
              <div key={idx} className="bento-card group flex flex-col items-center text-center p-10">
                ...
                <a href="https://linkedin.com/company/shipbridge" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/40 hover:text-white hover:bg-[#00ff87]/20 transition-all">

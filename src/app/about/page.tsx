  ...
  return (
    <main className="relative min-h-screen text-white bg-black logistics-grid">
      ...
      <section className="relative pt-48 pb-20 px-6 md:px-12 max-w-7xl mx-auto z-10">
        <div className="w-full">
          ...
          <p className="text-xl md:text-2xl text-white/50 tracking-tight font-light max-w-3xl mb-12 italic">
            Architecting the future of <span className="text-[#00ff87]">automated logistics</span> for the Indian subcontinent.
          </p>
          
          <div className="holo-glass p-8 md:p-12 rounded-3xl border-[#00ff87]/20 max-w-4xl">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="holo-glass p-8 rounded-2xl text-center group border-white/5">
              <div className="text-3xl md:text-5xl font-black text-[#00ff87] mb-2 font-mono tracking-tighter group-hover:scale-105 transition-transform">
                {stat.value}
              </div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7 space-y-12">
            ...
            <div className="space-y-8 text-white/50 text-lg font-light leading-relaxed">
              ...
              <p className="border-l-2 border-[#00ff87] pl-8 italic">
          ...
          <div className="lg:col-span-5">
            <div className="relative aspect-square holo-glass rounded-3xl flex items-center justify-center p-12 border-[#00ff87]/30">
               <div className="absolute inset-0 bg-[#00ff87]/5 animate-pulse" />
      ...
      <section className="relative py-48 px-6 md:px-12 text-center overflow-hidden">
        <div className="scanning-line" />
        <div className="max-w-4xl mx-auto holo-glass p-12 md:p-24 rounded-[4rem] border-[#00ff87]/20">
          ...
          <div className="mt-12 flex flex-col items-center">
            <div className="w-12 h-px bg-[#00ff87] mb-6" />

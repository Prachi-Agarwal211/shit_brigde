  ...
  return (
    ...
    >
      <div className="relative flex items-center gap-4">
        ...
        <div className="bg-black/80 backdrop-blur-md border border-[#FF9933]/30 px-4 py-2 rounded-lg opacity-0 -translate-x-4 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300">
          <span className="text-terminal text-[9px] font-bold whitespace-nowrap">PRIORITY_WA_NODE</span>
        </div>
        
        {/* WhatsApp Icon */}
        <div className="relative w-14 h-14 bg-[#138808] rounded-xl flex items-center justify-center shadow-[0_0_30px_rgba(19,136,8,0.4)] transition-transform duration-300 group-hover:scale-110">
          <div className="wa-pulse absolute inset-0 bg-[#138808] rounded-xl -z-10" />
